...
//     societyUser              SocietyProfile @relation("SocietyUsers",fields: [societyId], references: [societyId])
//   }
...
//     societyAchievements SocietyAchievment[] @relation("AchievementOfSociety")
...
//   model SocietyMember{
//     societyMemberId Int @id @default(autoincrement())
//     userId  Int
